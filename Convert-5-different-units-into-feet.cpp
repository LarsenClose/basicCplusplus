...
int main ( void )
{
    ...
    cout << "This program accepts a distance in miles, furlongs, yards, feet and inches" << endl;
    cout << "then converts those combined entries to a total number of feet." << endl;
	...
	//		5280 feet in a mile, 660.001 feet in a furlong, 3 feet in a yard and 1/12 feet in an inch
